...
def nodeCost(nodeCost, nextCost):
...
def dijAlgor(start_node, goal_node, boardState):
    ...
    while len(ndLst.Node_State_i) > 0:
        ...
        for newNodeMove in possibleMoves:
            ...
            newNodeCost = round(nodeCost(currentNodeCost, newNodeMove), 3)
...
def runFunctions():
  ...
  #  if (usrAns==1):
   ...
   # else:
    ...
    previous = dijAlgor(Start,Goal, boardState)
